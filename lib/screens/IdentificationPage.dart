        ...
        body: new Column(
          ...
          children: <Widget>[
            ...
            new Expanded(child: Container(
              child: new Image(image: AssetImage('assets/${node.optionA.getImageLocation()}')),
            ),),
            new GestureDetector(
            ...
            new Expanded(child: Container(
              child: new Image(image: AssetImage('assets/${node.optionB.getImageLocation()}')),
            ),),
            new GestureDetector(
      ...
      body: Padding(
        ...
        child: new ListView(
            children: <Widget>[
              ...
              new Image(image: AssetImage('assets/${finalResult.getImageLocation()}')),
            ]
        ),
